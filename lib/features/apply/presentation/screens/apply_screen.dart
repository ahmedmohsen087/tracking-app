...
import 'package:flowery_rider_app/features/apply/presentation/widgets/apply_form_body.dart';
      ...
      listener: (context, state) {
        if (state.applyState.data != null) {
          Navigator.of(context).pushReplacementNamed(
              AppRoutsName.successApplyScreen);
