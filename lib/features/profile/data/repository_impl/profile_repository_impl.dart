...
import '../../api/responses/edit_profile_response.dart';
import '../../api/responses/upload_photo_response.dart';
import '../../api/responses/vehicle_types_response.dart';
import '../../domain/mappers/profile_response_model_mapper.dart';
...
class ProfileRepositoryImpl implements ProfileRepositoryContract {
  ...
  Future<BaseResponse<ProfileResponseEntity>> changePassword({
    ...
    final response = await _profileRemoteDataSourceContract.changePassword(
  ...
  Future<BaseResponse<VehicleInfoUpdatedEntity>> editVehicleInfo({
    ...
    final response = await _profileRemoteDataSourceContract.editVehicleInfo(
      requestModel: requestModel,
    );
  ...
  Future<BaseResponse<VehicleTypesResponseEntity>> getVehicleTypes({
    ...
    final response = await _profileRemoteDataSourceContract.getVehicleTypes(
      page: page,
      limit: limit,
    );
  ...
  Future<BaseResponse<String>> uploadPhoto({required String filePath}) async {
    final response = await _profileRemoteDataSourceContract.uploadPhoto(
        filePath: filePath);
